...
// Mount an Azure Files share for persisting Copilot SDK agent session state so that
// multi-turn conversations survive cold starts, scale-out, and instance recycling.
